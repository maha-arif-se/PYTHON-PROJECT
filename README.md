...
A fun and interactive Python game built using the Pygame library where the player controls a paddle to catch falling balls and score points. The game was enhanced with multiple features to improve gameplay experience and make it more engaging
Features Added
